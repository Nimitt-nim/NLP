...
#words_in_english = words.words("en")
# Following lines of code will create dictionary: Key: word, Value: set of context words with whom this word is present
word_to_word_sparse_dict = {}
for key in processed_corpus:
	for word in processed_corpus[key]:
		if word not in word_to_word_sparse_dict:
			word_to_word_sparse_dict[word] = set()
		word_to_word_sparse_dict[word].update(processed_corpus[key]-set(word.split()))	
...
print(cosine_sim("hospital","pilot"))
